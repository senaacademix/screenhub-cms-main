  ...
  useEffect(() => {
    if (content) {
      form.reset({
        ...
        url: content.url || "",
        body: content.body || "",
        bgType: (content as any).bgType || "gradient",
        bgValue: (content as any).bgValue || "linear-gradient(135deg, #0a0f24 0%, #050811 50%, #120e29 100%)",
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input 
                                  placeholder={
                                    contentType === "web" || contentType === "qr"
